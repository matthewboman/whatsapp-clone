  ...
  return (
    <Style className="GroupDetailsScreen Screen">
      ...
      <ul className="GroupDetailsScreen-participants-list">
        {
          participants.map(p => (
            <div key={p.id} className="GroupDetailsScreen-participant-item">
              <img
                src={p.picture || '/assets/default-profile-pic.jpg'}
                className="GroupDetailsScreen-participant-picture"
              />
              <span className="GroupDetailsScreen-participant-name">
                { p.name }
              </span>
            </div>
          ))
