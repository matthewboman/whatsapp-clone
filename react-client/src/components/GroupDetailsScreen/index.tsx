...
import { MutationHookOptions, useQuery, useMutation } from 'react-apollo-hooks'
...
const mutation = gql`
  mutation GroupDetailsScreenMutation($chatId: ID!, $groupName: String, $groupPicture: String) {
    updateGroup(chatId: $chatId, groupName: $groupName, groupPicture: $groupPicture) {
      ...Chat
    }
  }
  ${fragments.chat}
